...
public class ReportFactoryTest {
  ...
  public void setUpReportFactory() {
    reportFactory = new ReportFactory(dailyIngredientReportInformationFactory);
  }
  ...
  public void givenIngredientsQuantities_whenCreate_thenDailyIngredientReportInformationAreCreatedForEachDay() {
    ...
    // when
    reportFactory.create(ingredientPriceCalculator, dateToIngredientsQuantities);
  ...
  public void givenIngredientsQuantities_whenCreate_thenReportIsCorrectlyCreated() {
    ...
    // when
    Report report = reportFactory.create(ingredientPriceCalculator, dateToIngredientsQuantities);

    // then
    assertThat(report.getDailyIngredientsInformation()).containsExactlyEntriesIn(Map.of(A_DATE,

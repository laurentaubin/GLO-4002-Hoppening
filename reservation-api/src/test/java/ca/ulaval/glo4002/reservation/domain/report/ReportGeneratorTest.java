...
public class ReportGeneratorTest {
  ...
  public void setUpReportGenerator() {
    reportGenerator = new ReportGenerator(ingredientPriceCalculatorFactory, reportFactory);
  }
  ...
  public void whenGenerateReport_thenIngredientPriceCalculatorFactoryIsCalled() {
    ...
    // when
    reportGenerator.generateReport(ingredientPriceDtos, any());
  ...
  public void whenGenerateReport_thenReportFactoryIsCalled() {
    ...
    // when
    reportGenerator.generateReport(ingredientPriceDtos, dateToIngredientQuantities);

    // then
    verify(reportFactory).create(ingredientPriceCalculator, dateToIngredientQuantities);
  }

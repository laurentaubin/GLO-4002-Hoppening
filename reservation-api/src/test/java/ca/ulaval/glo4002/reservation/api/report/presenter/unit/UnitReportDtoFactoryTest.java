...
public class UnitReportDtoFactoryTest {
  ...
  public void givenReport_whenCreate_thenDailyIngredientInformationAreFetched() {
    // when
    unitReportDtoFactory.create(report);

    // then
    verify(report).getDailyIngredientsInformation();
  }
  ...
  public void givenReport_whenCreate_thenCorrespondingUnitReportDayDtosAreCreated() {
    ...
    given(report.getDailyIngredientsInformation()).willReturn(givenDailyIngredientReportInformation);
